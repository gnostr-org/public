...
${originalIndentation}`;
  ...
  var RelayPool = class {
    ...
    #subscribeRelay(relay, filters, onEvent, onEose, dontStoreEventsBySub) {
    ...
    #subscribeRelays(filtersByRelay, onEvent, onEose, unsub = {}, minMaxDelayms, dontStoreEventsBySub) {
      ...
      for (const [relay, filters] of filtersByRelay) {
        let subHolder = {};
        const subOnEose = (events, url, minCreatedAt) => {
          if (onEose) {
