...
dependencies:
  '@nostr-dev-kit/ndk':
    specifier: ^0.7.7
    version: 0.7.7(typescript@5.2.2)
  body-parser:
    specifier: ^1.20.2
    version: 1.20.2
  dotenv:
...
packages:
  ...
  /@nostr-dev-kit/ndk@0.7.7(typescript@5.2.2):
  ...
  /create-esm-loader@0.2.4:
    resolution: {integrity: sha512-COjlrIKjDjMy1NGpZCn69wYxwMuA/YCfe94YYoO+4nGuDm2Q3V1Q3yo/FzJtgdSAsjuA7E8yoVGU5UdcTSj5+w==}
    engines: {node: '>=14.x'}
    dependencies:
      semver: 7.5.4
    dev: false
